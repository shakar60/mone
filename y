...
local Window = Library.CreateLib("shakars hub", "Synapse")

-- Tabs

local Tab1 = Window:NewTab("Fe scripts")
local Tab2 = Window:NewTab("Hubs/Guis")
local Tab3 = Window:NewTab("Dh Scripts")
...
Tab1Section:NewSlider("Walkspeed", "Makes You Walk Faster", 500, 16, function(s) -- 500 (MaxValue) | 16 (MinValue)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
end)

Tab1Section:NewSlider("JumpPower", "Makes You Jump Higher", 500, 50, function(s) -- 500 (MaxValue) | 50 (MinValue)
...
Tab2Section:NewButton("Kat Aimbot", "Gets You Aimbot In Kat", function()
...
Tab2Section:NewButton("Ragdoll Engine Malware Hub", "Gives You An Hub For Ragdoll Engine", function()
...
Tab1Section:NewButton("Fly Script", "Makes You Lag", function()
loadstring(game:HttpGet('https://pastebin.com/raw/YSL3xKYU'))()
    print("Clicked")
end)

Tab7Section:NewButton("Infinite Yeild", "Loads Infinite Yield Script", function()
loadstring(game:HttpGet"https://pastebin.com/raw/3P1z104N")()
    print("Clicked")
end)
...
Tab1Section:NewButton("Invisible Script", "Makes You Invisible Fe", function()
loadstring(game:HttpGet('https://pastebin.com/raw/AYtzGEPb'))()
    print("Clicked")
end)

Tab2Section:NewButton("Cheesy Hub", "Loads Cheesy Hub", function()
...
loadstring(game:HttpGet(('https://0raw.githubusercontent.com/0Ben1/fe/main/Tp%20Place%20GUI'),true))()
    print("Clicked")
end)
...
Tab2Section:NewButton("Dh Aim Viewer Script", "Loads Da Hood Aim Viewer Script", function()
...
Tab3Section:NewButton("Dh Private Kai Lock", "Loads a Tool That Gives You Lock In Dh", function()
...
Tab2Section:NewButton("Ragdoll Engine Script V2", "Loads A Diffrent Ragdoll Engine Scropt", function()
...
Tab9Section:NewButton("Chat Bypass Script", "Loads a Hub With Swear Words", function()
...
Tab9Section:NewButton("Q Tool Script", "Loads An Script That Gives You Q Tool", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/scripthubekitten/qtoolv3/main/qtoolv3", true))()
    print("Clicked")
end)

Tab3Section:NewButton("Dhat Lock Script", "Loads Dhat Lock Tool", function()
loadstring(game:HttpGet("https://pastebin.com/raw/j08xM9mW", true))()
    print("Clicked")
end)
...
Tab9Section:NewButton("Teleport Script", "Loads An Script That Lets You Teleport Other Players", function()
loadstring(game:HttpGet(("https://pastebin.com/raw/YNVbeqPy")))()
    print("Clicked")
end)

Tab9Section:NewButton("No Clip Gui", "Loads An Gui ThatLets You Go Inside Of Anything", function()
loadstring(game:HttpGet("https://pastebin.com/raw/pKV2Ys4E"))()
    print("Clicked")
end)

Tab3Section:NewButton("Lock Tools Gui", "Loads An Hub With Alot Of Lock Tools", function()
loadstring(game:HttpGet("https://pastebin.com/raw/8G5wzp3L"))()
    print("Clicked")
end)

Tab3Section:NewButton("Dhat Fake Macro", "Loads Dhat Fake Macro", function()
loadstring(game:HttpGet("https://pastebin.com/raw/Zk7tY25L", true))()
    print("Clicked")
end)
...
Tab4Section:NewButton("Blox Fruit Gui V2", "Loads a Blox Fruit Gui With Alot Of Stuffs", function()
...
Tab9Section:NewButton("Universal Spy Script", "Loads a Script That Lets You Spy Other People", function()
...
Tab9Section:NewButton("KeyStrokes Script", "Loads WASD KeyStrokes Script", function()
loadstring(game:HttpGet(('https://pastefy.app/Te4dwSw2/raw'),true))()
    print("Clicked")
end)

Tab1Section:NewButton("Anti Fling Script", "Loads a Script That Wont Let You Get Flinged", function()
...
Tab18Section:NewLabel("All Credits is going to me")

Tab18Section:NewLabel("discord is shakar#6955")

Tab18Section:NewLabel("i dont give credits to scripts")

Tab18Section:NewLabel("Script gui/hub is made by shakar#6955")
...
Tab1Section:NewButton("Tool giver", "Loads An Script That Gives You Some Tools", function()
...
Tab1Section:NewButton("99% fil impossible obby script", "Loads An Script memory all the path", function()
